    ...
    try:
        ...
        if id_list:
            ...
            if models_list:
                ...
                if language == 'ru':
                    t = InlineKeyboardButton(text='Добавить авто', callback_data=f"button:add", resize_keyboard=True)
                elif language == 'am':
                    t = InlineKeyboardButton(text='Ավելացնել ավտո', callback_data=f"button:add", resize_keyboard=True)
    ...
    try:
        ...
        for i, brand in enumerate(car_brands):
            if i == len(car_brands) - 1:
                button = InlineKeyboardButton(text=brand, callback_data=f"cdcondition:{brand}", resize_keyboard=True)
            else:
                button = InlineKeyboardButton(text=brand, callback_data=f"cdcondition:{brand}")
...
async def models_callback_button(callback_query: types.CallbackQuery):
    try:
        ...
        brand_keyboard_mapping = {
            ...
            'LADA': generate_lada_models_inline_keyboard,
...
def generate_models_inline_keyboard(brand, models):
    ...
    for model in models:
        ...
        button = InlineKeyboardButton(text=cmodel, callback_data=f"cdmodel:{model}:{brand}")
        buttons.append(button)
    other_brand = f'other_{brand}'
    other_brand = other_brand.lower()
    keyboard.add(*buttons)
    keyboard.row(
        InlineKeyboardButton(text="Не вижу моей модели в списке", callback_data=f"cdmodel:{other_brand}:{brand}",
...
def generate_kia_models_inline_keyboard(brand):
    models = ["Bongo", "Carens", "Carnival", "Ceed", "Cerato", "Forte", "K5", "Magentis", "Mohave", "Optima", "Picanto",
...
def generate_lada_models_inline_keyboard(brand):
    models = ["1111 Oka", "2101", "2102", "2103", "2104", "2105", "2106", "2107", "2108", "2109", "21099", "2110",
              "2111", "2112", "2113", "2114", "2115", "2121", "2131", "Granta", "Kalina",
              "Largus", "NIVA", "NIVA Legend", "Priora", "Vesta", "XRAY", "X-cross 5"]
    return generate_models_inline_keyboard(brand, models)
...
def other_car_brands_inline_keyboard():
    keyboard = InlineKeyboardMarkup(row_width=4)
    buttons = [
        InlineKeyboardButton(text="Acura", callback_data=f"cdyear:Non:Non:Acura"),
        InlineKeyboardButton(text="Alfa Romeo", callback_data=f"cdyear:Non:Non:Alfa Romeo"),
        InlineKeyboardButton(text="Aston Martin", callback_data=f"cdyear:Non:Non:Aston Martin"),
        InlineKeyboardButton(text="Aurus", callback_data="cdyear:Non:Non:Aurus"),
        InlineKeyboardButton(text="Bentley", callback_data="cdyear:Non:Non:Bentley"),
        InlineKeyboardButton(text="Brilliance", callback_data="cdyear:Non:Non:Brilliance"),
        InlineKeyboardButton(text="Buick", callback_data="cdyear:Non:Non:Buick"),
        InlineKeyboardButton(text="BYD", callback_data="cdyear:Non:Non:BYD"),
        InlineKeyboardButton(text="Changan", callback_data="cdyear:Non:Non:Changan"),
        InlineKeyboardButton(text="Chery", callback_data="cdyear:Non:Non:Chery"),
        InlineKeyboardButton(text="Daihatsu", callback_data="cdyear:Non:Non:Daihatsu"),
        InlineKeyboardButton(text="Datsun", callback_data="dyear:Non:Non:Datsun"),
        InlineKeyboardButton(text="DongFeng", callback_data="dyear:Non:Non:DongFeng"),
        InlineKeyboardButton(text="Evolute", callback_data="cdyear:Non:Non:Evolute"),
        InlineKeyboardButton(text="Exeed", callback_data="cdyear:Non:Non:Exeed"),
        InlineKeyboardButton(text="FAW", callback_data="cdyear:Non:Non:FAW"),
        InlineKeyboardButton(text="Ferrari", callback_data="cdyear:Non:Non:Ferrari"),
        InlineKeyboardButton(text="Foton", callback_data="cdyear:Non:Non:Foton"),
        InlineKeyboardButton(text="GAC", callback_data="cdyear:Non:Non:GAC"),
        InlineKeyboardButton(text="GAZ", callback_data="cdyear:Non:Non:GAZ"),
        InlineKeyboardButton(text="Geely", callback_data="cdyear:Non:Non:Geely"),
        InlineKeyboardButton(text="Genesis", callback_data="cdyear:Non:Non:Genesis"),
        InlineKeyboardButton(text="GMC", callback_data="cdyear:Non:Non:GMC"),
        InlineKeyboardButton(text="Great Wall", callback_data="cdyear:Non:Non:Great Wall"),
        InlineKeyboardButton(text="Hafei", callback_data="cdyear:Non:Non:Hafei"),
        InlineKeyboardButton(text="Haima", callback_data="cdyear:Non:Non:Haima"),
        InlineKeyboardButton(text="Haval", callback_data="cdyear:Non:Non:Haval"),
        InlineKeyboardButton(text="Hawtai", callback_data="cdyear:Non:Non:Hawtai"),
        InlineKeyboardButton(text="Hongqi", callback_data="cdyear:Non:Non:Hongqi"),
        InlineKeyboardButton(text="Hummer", callback_data="cdyear:Non:Non:Hummer"),
        InlineKeyboardButton(text="Iran Khordo", callback_data="cdyear:Non:Non:Iran Khordo"),
        InlineKeyboardButton(text="Isuzu", callback_data="cdyear:Non:Non:Isuzu"),
        InlineKeyboardButton(text="JAC", callback_data="cdyear:Non:Non:JAC"),
        InlineKeyboardButton(text="Jaguar", callback_data="cdyear:Non:Non:Jaguar"),
        InlineKeyboardButton(text="Lamborghini", callback_data="cdyear:Non:Non:Lamborghini"),
        InlineKeyboardButton(text="Lancia", callback_data="cdyear:Non:Non:Lancia"),
        InlineKeyboardButton(text="Lifan", callback_data="cdyear:Non:Non:Lifan"),
        InlineKeyboardButton(text="Lincoln", callback_data="cdyear:Non:Non:Lincoln"),
        InlineKeyboardButton(text="Luxgen", callback_data="cdyear:Non:Non:Luxgen"),
        InlineKeyboardButton(text="Maserati", callback_data="cdyear:Non:Non:Maserati"),
        InlineKeyboardButton(text="Maybach", callback_data="cdyear:Non:Non:Maybach"),
        InlineKeyboardButton(text="Mercury", callback_data="cdyear:Non:Non:Mercury"),
        InlineKeyboardButton(text="MG", callback_data="cdyear:Non:Non:MG"),
        InlineKeyboardButton(text="Mini", callback_data="cdyear:Non:Non:Mini"),
        InlineKeyboardButton(text="Moskvich", callback_data="cdyear:Non:Non:Moskvich"),
        InlineKeyboardButton(text="Omoda", callback_data="cdyear:Non:Non:Omoda"),
        InlineKeyboardButton(text="Plymouth", callback_data="cdyear:Non:Non:Plymouth"),
        InlineKeyboardButton(text="Pontiac", callback_data="cdyear:Non:Non:Pontiac"),
        InlineKeyboardButton(text="Ravon", callback_data="cdyear:Non:Non:Ravon"),
        InlineKeyboardButton(text="Rolls-Royce", callback_data="cdyear:Non:Non:Rolls Royce"),
        InlineKeyboardButton(text="Rover", callback_data="cdyear:Non:Non:Rover"),
        InlineKeyboardButton(text="Saab", callback_data="cdyear:Non:Non:Saab"),
        InlineKeyboardButton(text="Saturn", callback_data="cdyear:Non:Non:Saturn"),
        InlineKeyboardButton(text="Scion", callback_data="cdyear:Non:Non:Scion"),
        InlineKeyboardButton(text="Seat", callback_data="cdyear:Non:Non:Seat"),
        InlineKeyboardButton(text="Smart", callback_data="cdyear:Non:Non:Smart"),
        InlineKeyboardButton(text="TagAZ", callback_data="cdyear:Non:Non:TagAZ"),
        InlineKeyboardButton(text="Tesla", callback_data="cdyear:Non:Non:Tesla"),
        InlineKeyboardButton(text="UAZ", callback_data="cdyear:Non:Non:UAZ"),
        InlineKeyboardButton(text="Vortex", callback_data="cdyear:Non:Non:Vortex"),
        InlineKeyboardButton(text="ZAZ", callback_data="cdyear:Non:Non:ZAZ"),
        InlineKeyboardButton(text="Zotye", callback_data="cdyear:Non:Non:Zotye"),
        InlineKeyboardButton(text="ZX auto", callback_data="cdyear:Non:Non:ZX auto")
    ]
...
async def years_callback_button(callback_query: types.CallbackQuery):
    ...
    car_models = {
        ...
        "1111 Oka": generate_years_lada_1111_Oka,
        "2101": generate_years_lada_2101,
        "2102": generate_years_lada_2102,
        "2103": generate_years_lada_2103,
        "2104": generate_years_lada_2104,
        "2105": generate_years_lada_2105,
        "2106": generate_years_lada_2106,
        "2107": generate_years_lada_2107,
        "2108": generate_years_lada_2108,
        "2109": generate_years_lada_2109,
        "21099": generate_years_lada_21099,
        "2110": generate_years_lada_2110,
        "2111": generate_years_lada_2111,
        "2112": generate_years_lada_2112,
        "2113": generate_years_lada_2113,
        "2114": generate_years_lada_2114,
        "2115": generate_years_lada_2115,
        "2121": generate_years_lada_2121,
        "2131": generate_years_lada_2131,
        "Granta": generate_years_lada_Granta,
        "Kalina": generate_years_lada_Kalina,
        "Largus": generate_years_lada_Largus,
        "NIVA": generate_years_lada_NIVA,
        "NIVA Legend": generate_years_lada_NIVA_Legend,
        "Priora": generate_years_lada_Priora,
        "Vesta": generate_years_lada_Vesta,
        "XRAY": generate_years_lada_XRAY,
        "X-cross 5": generate_years_lada_X_cross_5,
        ...
        "Forte": generate_years_kia_Forte,
...
def generate_years(model, brand, lst):
    ...
    buttons = [InlineKeyboardButton(text=str(year), callback_data=f"cdyear:{year}:{model}:{brand}")
...
def generate_other_models(brand, models):
    keyboard = InlineKeyboardMarkup(row_width=4)
    year = 'Non'
    buttons = [InlineKeyboardButton(text=model, callback_data=f"cdyear:{year}:{model}:{brand}") for model in models]
    keyboard.add(*buttons)
    return keyboard
...
def generate_years_kia_Forte(model, brand):
    return generate_years(model, brand,
                          ["2008-2013", "2013-2016", "2016-2018", "2017-2022", "2018-2021", "2021-2023"])
...
def generate_years_lada_1111_Oka(model, brand):
    return generate_years(model, brand, ['1987-2008'])


def generate_years_lada_2101(model, brand):
    return generate_years(model, brand, ['1970-1988'])


def generate_years_lada_2102(model, brand):
    return generate_years(model, brand, ['1971-1986'])


def generate_years_lada_2103(model, brand):
    return generate_years(model, brand, ['1972-1984'])


def generate_years_lada_2104(model, brand):
    return generate_years(model, brand, ['1984-2012'])


def generate_years_lada_2105(model, brand):
    return generate_years(model, brand, ['1979-2011'])


def generate_years_lada_2106(model, brand):
    return generate_years(model, brand, ['1976-2006'])


def generate_years_lada_2107(model, brand):
    return generate_years(model, brand, ['1982-2012'])


def generate_years_lada_2108(model, brand):
    return generate_years(model, brand, ['1984-2005'])


def generate_years_lada_2109(model, brand):
    return generate_years(model, brand, ['1987-2006'])


def generate_years_lada_21099(model, brand):
    return generate_years(model, brand, ['1990-2011'])


def generate_years_lada_2110(model, brand):
    return generate_years(model, brand, ['1995-2014'])


def generate_years_lada_2111(model, brand):
    return generate_years(model, brand, ['1997-2009'])


def generate_years_lada_2112(model, brand):
    return generate_years(model, brand, ['1998-2009'])


def generate_years_lada_2113(model, brand):
    return generate_years(model, brand, ['2004-2013'])


def generate_years_lada_2114(model, brand):
    return generate_years(model, brand, ['2001-2013'])


def generate_years_lada_2115(model, brand):
    return generate_years(model, brand, ['1997-2012'])


def generate_years_lada_2121(model, brand):
    return generate_years(model, brand, ['1997-1994', '1993-2020', '2019-2021'])


def generate_years_lada_2131(model, brand):
    return generate_years(model, brand, ['1993-2019', '2019-2021'])


def generate_years_lada_Granta(model, brand):
    return generate_years(model, brand, ['2011-2018', '2018-2023'])


def generate_years_lada_Kalina(model, brand):
    return generate_years(model, brand, ['2004-2013', '2013-2018'])


def generate_years_lada_Largus(model, brand):
    return generate_years(model, brand, ['2012-2021', '2021-2023'])


def generate_years_lada_NIVA(model, brand):
    return generate_years(model, brand, ['2020-2021', '2020-2023'])


def generate_years_lada_NIVA_Legend(model, brand):
    return generate_years(model, brand, ['2021-2023'])


def generate_years_lada_Priora(model, brand):
    return generate_years(model, brand, ['2007-2013', '2013-2018'])


def generate_years_lada_Vesta(model, brand):
    return generate_years(model, brand, ['2015-2022', '2022-2023'])


def generate_years_lada_XRAY(model, brand):
    return generate_years(model, brand, ['2015-2022'])


def generate_years_lada_X_cross_5(model, brand):
    return generate_years(model, brand, ['2023-2022'])
...
async def year_callback_button(callback_query: types.CallbackQuery):
    ...
    s = 0
    await bot.send_message(user_id, f'{ac} - {c}')
...
'''    elif model == 'Non':
        ...
        if k != 2 and k != 3:
            ...
            await bot.send_message(user_id, f'{sad} {brand} {model}')
        if s == 0:
            bot_car.add_car_other_login(brand, login[0])
            await bot.send_message(user_id, f'{sp}')
            await bot.send_message(user_id, f'{vr} {brand} {model} {year}')
        else:
            await bot.send_message(user_id, f'{vu}')
        ...
        if k[0] != 2 and k[0] != 3:
            ...
            await bot.send_message(user_id, f'{sad} {brand} {model}')
        if s == 0:
            bot_car.add_other_car_login(brand, model, login[0])
            await bot.send_message(user_id, f'{sp}')
            await bot.send_message(user_id, f'{vr} {brand} {model} {year}')
        else:
            await bot.send_message(user_id, f'{vu}')
        await bot.send_message(1806719774, f' #newauto Автораборка {login} разбирает новое авто {brand}, {model}')'''
...
def register_handlers_car_disassembly(dp: Dispatcher):
    ...
    dp.register_message_handler(car_disassembly, commands=['car_disassembly'])
    dp.register_callback_query_handler(models_callback_button, lambda c: c.data.startswith('cdcondition:'))
    dp.register_callback_query_handler(year_callback_button, lambda c: c.data.startswith('cdyear:'))
    dp.register_callback_query_handler(years_callback_button, lambda c: c.data.startswith('cdmodel:'))
