token = '6112966117:AAHZadsmN2L6hNEoKVNyWhEdM4ZGMxoEvGw'

#  RU start_lang_hand
t1: str = "Запрос"
t2: str = "Автосервисы (скоро)"
t3: str = "Авто в разборе"
t4: str = "Авторизация"
t5: str = "Аккаунт"

sm = 'Я могу искать автозапчасти у партнеров \nharcum-pahestamaser.ru'
...
/ads - поиск запчастей по названию
...
c3: str = "Ավտո վերլուծության մեջ"
c4: str = "Թույլտվություն"
c5: str = "Հաշիվ"
...
/ads - ավտոպահեստամասերի որոնում ըստ անվանման
/disassembly - авто в разборе
/org - ավտոմեքենաների ապամոնտաժում
/feedback - հետադարձ կապ
/language - լեզուն փոխելը զրուցարանում
/login - գրանցում/регистрация '''
...
ru_b = 'Выберете способ входа в аккаунт'
...
am_b = 'Ընտրեք հաշիվ մուտք գործելու եղանակը'
